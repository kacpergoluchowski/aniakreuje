...
export default function PortfolioSection() {
    ...
    return (
        <div className="portfolio-section">
            <svg id ='scrollPortfolio' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"> <path fill="#ffffff" fill-opacity="1" d="M0,128L48,128C96,128,192,128,288,112C384,96,480,64,576,80C672,96,768,160,864,197.3C960,235,1056,245,1152,234.7C1248,224,1344,192,1392,176L1440,160L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path> </svg>
            <div>
                <div data-aos = 'fade-right' data-aos-duration='2000'>
                    ...
                    <Link to = 'portfolio'> <button className="btn" onClick={scrollToTop}> Moje dzieła  </button> </Link>
                </div>
